...
// Define your routes
router.get('/inventoryManagers', managerController.getInventoryManager); 
...
router.put('/updateinventoryManager', upload.single("profile_image"), managerController.updateInventoryManager);
